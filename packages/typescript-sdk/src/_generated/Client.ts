...
export declare namespace GeneralAugmentClient {
...
export class GeneralAugmentClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<GeneralAugmentClient.Options>;
    protected _agent: AgentClient | undefined;
    protected _responses: ResponsesClient | undefined;

    constructor(options: GeneralAugmentClient.Options = {}) {
