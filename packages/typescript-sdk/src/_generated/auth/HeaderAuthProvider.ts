...
const PARAM_KEY = "adminKey" as const;
const ENV_HEADER_KEY = "GENERAL_AUGMENT_ADMIN_KEY" as const;
const HEADER_NAME = "X-Admin-Key" as const;
...
export namespace HeaderAuthProvider {
    export const AUTH_SCHEME = "AdminKeyAuth" as const;
